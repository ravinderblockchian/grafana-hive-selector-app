// @ts-nocheck
// Note: grafana-public-path is handled by webpack virtual module
// The public path will be set correctly by Grafana at runtime

import { PanelPlugin } from '@grafana/data';
import { SiteManagerDashboardPanel } from './SiteManagerDashboardPanel';
import { NestedOptions } from '../../shared/types';
import { defaultTree } from '../../shared/constants';

export const plugin = new PanelPlugin<NestedOptions>(SiteManagerDashboardPanel)
  .setNoPadding()
